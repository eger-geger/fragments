...
public class FragmentContextSupport implements FragmentContext {
	...
	public FragmentContextSupport(SearchContext searchContext, JavascriptExecutor jsExecutor, FragmentFactory fragmentFactory, String contextName) {
